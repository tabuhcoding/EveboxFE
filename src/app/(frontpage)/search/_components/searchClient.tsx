...
import { SearchEventsResponse, Event } from '@/types/models/dashboard/searchEvents.interface';
...
export default function SearchClient({ events: initialEvents }: SearchClientProps) {
  ...
  const currentQuery = searchParams.get('title') || '';
  ...
  const applyFilters = async () => {
    ...
    try {
      ...
      const newEvents = await getSearchEvents({
        title,
