...
export default function UserInstruction({ activeDetail }: UserInstructionProps) {
  return (
    <div className="flex-1 border-l border-gray-300 p-6 overflow-y-auto max-h-[80vh]">
              ...
              {!activeDetail && (
                <p className="text-gray-500 text-sm italic">Chọn một mục để xem hướng dẫn chi tiết tại đây.</p>
              )}
               ...
               {activeDetail === 'sign-up' && (
                <>
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Người dùng truy cập trang “Đăng ký”, điền các thông tin bắt buộc như họ tên, email, số điện thoại và mật khẩu.</li>
                   <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/signup1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Hệ thống sẽ gửi email xác thực để hoà tất..</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/signup2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
              ...
              {activeDetail === 'sign-in' && (
                <>
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Người dùng có thể đăng nhập bằng tài khoản email đã đăng ký hoặc sử dụng phương thức đăng nhập nhanh qua Google.</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/signin1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
              ...
              {activeDetail === 'update-profile' && (
                <>
                  <h2 className="text-xl font-semibold mb-2">Cập nhật thông tin và mật khẩu</h2>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Sau khi đăng nhập, truy cập vào mục “Quản lý tài khoản” bằng cách mở thanh bên và bấm vào nút “Quản lý tài khoản” hoặc bấm vào tên đăng nhập ở góc trên bên phải</li>
                    <div className="flex justify-center my-2">
          <Image
          ...
          />
                    ...
                    <li>Mặc định là sẽ ở tab “Thông tin cá nhân”, có thể xem và chỉnh sửa họ tên, số điện thoại cùng ảnh đại diện.</li>
        <div className="flex justify-center my-2">
          <Image
          ...
          />
                    ...
                    <li>Khi cập nhật ảnh đại diện, có thể lựa chọn “Tải ảnh lên” để tải ảnh lên từ máy tính hoặc “Chọn từ ảnh đã tải lên” để chọn ảnh đã được tải lên trước đó</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/account3.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/account4.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Ở thanh bên, bấm nút “Đổi mật khẩu mới” để cập nhật mật khẩu mới sau khi xác thực mật khẩu cũ</li>
                  <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/account5.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/account6.png"
            alt="EveBox"
            width={500}
            height={400}
          />
              ...
              {activeDetail === 'search-event' && (
                <>
                  <h2 className="text-xl font-semibold mb-2">Tìm kiếm và Lọc sự kiện</h2>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Sử dụng thanh tìm kiếm ở trang chủ để tìm sự kiện theo tên hoặc từ khóa</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/search1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Sử dụng các bộ lọc nâng cao để tìm kiếm theo danh mục (âm nhạc, hội thảo...), địa điểm, khoảng thời gian, giá vé</li>
                  <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/search2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
                   ...
                   <h2 className="text-xl font-semibold mb-2 mt-2">Sử dụng trợ lý ảo (AI Chatbot)</h2>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Nhấn vào biểu tượng AI Chatbot trên giao diện</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/ai1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/ai2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Có thể chọn các lựa chọn có sẵn của hệ thống hoặc nhập các câu hỏi bằng ngôn ngữ tự nhiên để tìm kiếm sự kiện (ví dụ: "Tìm cho tôi các sự kiện âm nhạc diễn ra ở Đà Lạt"). Chatbot sẽ phân tích và trả về kết quả phù hợp.</li>
                 <p>Chọn các lựa chọn có sẵn:</p>
                  <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/ai3.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/ai4.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
               <p>Nhập yêu cầu bằng ngôn ngữ tự nhiên:</p>
               <div className="flex justify-center my-2">
          <Image
        ...
        <div className="flex justify-center my-2">
          ...
          />
              ...
              {activeDetail === 'follow-event' && (
                <>
                  <h2 className="text-xl font-semibold mb-2 mt-2">Quản lý Danh sách Yêu thích</h2>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Tại trang chi tiết của một sự kiện hoặc nhà tổ chức, nhấn vào biểu tượng "Trái tim" để thêm vào danh sách yêu thích hoặc có thêm nhanh bằng cách nhấn vào biểu tượng trái tim ở các sự kiện tại trang chủ để thêm vào danh sách yêu thích.</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/fav1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Truy cập mục "Tài khoản" - "Danh sách yêu thích" để xem lại các mục đã lưu và quản lý nhận thông báo.</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/fav2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
      ...
      ></iframe>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    ...
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Chọn loại vé và số lượng. Nếu sự kiện có sơ đồ ghế, người dùng có thể trực tiếp chọn vị trí mong muốn.</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Hệ thống sẽ tạm giữ vé trong 20 phút. Người dùng tiến hành điền thông tin vào form (nếu có) và chuyển đến bước thanh toán.</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy3.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy4.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Lựa chọn phương thức thanh toán qua PayOS và hoàn tất giao dịch.</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy5.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Hệ thống sẽ dẫn qua trang PayOS để tiến hành quét mã thanh toán</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy6.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy7.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Sau khi thanh toán thành công, hệ thống sẽ gửi email xác nhận kèm vé điện tử có mã QR, sau đó dẫn đến trang thanh toán thành công</li>
                  <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/buy8.png"
            alt="EveBox"
            width={500}
            height={400}
          />
              ...
              {activeDetail === 'view-qr' && (
                <>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                                   <h2 className="text-xl font-semibold mb-2 mt-2">Xem vé và mã QR</h2>
                    <li>Ở thanh bên có nút “Quản lý vé”, bấm vào đây để đến trang danh sách các vé đã mua</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/qr1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Hiển thị danh sách các vé đã mua, có thể tìm kiếm theo sự kiện của vé, lọc theo tình trạng của vé (Tất cả, Thành công, Đang xử lý, Đã hủy) hoặc là thời gian diễn ra sự kiện (Sắp diễn ra, Đã kết thúc)</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/qr2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Khi bấm vào từng vé, sẽ xem được thông tin chi tiết của vé đã mua</li>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/qr3.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/user/qr4.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                    <li>Xem mã QR (dành cho ứng dụng di động)</li>
                  </ul>
                </>
              )}
      ...
      ></iframe>
                  ...
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    ...
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/org/cr1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        </div>
                   <p>Một popup với nội dung “Bạn chưa đăng ký thông tin thanh toán với tư cách nhà tổ chức” hiển thị với 2 sự lựa chọn: “Tiếp tục tạo sự kiện” hoặc “Đăng lý tổ chức”</p>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/org/cr2.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          ...
          />
              ...
              {activeDetail === 'org-management' && (
                <>
                  <h2 className="text-xl font-semibold mb-2">Quản lý cho organizer</h2>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Quản lý sự kiện</li>
                    <p>Người dùng có thể quản lý các sự kiện của mình với 3 trạng thái tương ứng 3 tab “Sắp tới / Đã qua / Chờ duyệt”</p>
                    <div className="flex justify-center my-2">
          <Image
            src="/images/instruction/org/mn1.png"
            alt="EveBox"
            width={500}
            height={400}
          />
        ...
        <div className="flex justify-center my-2">
          ...
          />
               ...
               {activeDetail === 'organizer-analytics' && (
                <>
                  <h2 className="text-xl font-semibold mb-2">Vận hành và Thống kê (trên ứng dụng di động)</h2>
                  <ul className="list-disc list-inside text-sm space-y-1 text-gray-700">
                    <li>Xem doanh thu, lượt vé đã bán.</li>
                    <li>Theo dõi lượt truy cập và tương tác.</li>
                    <li>Xuất báo cáo và phân tích hiệu quả.</li>
                  </ul>
                </>
              )}
            </div>
