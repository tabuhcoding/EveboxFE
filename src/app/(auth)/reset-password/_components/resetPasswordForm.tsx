                        ...
                        <div className="form">
                            <div className="container d-flex flex-column align-items-center">
                                <Image
                                    ...
                                    className="logo"
                                />
                                <h3 ><strong>{t('titleResetPass')}</strong></h3>
                                <p className="subheading">{t('promptNewPass')}</p>
                            </div>
                            <form onSubmit={formik.handleSubmit}>
                                <div className="mb-3">
                                    <label htmlFor="email" className="form-label bold-label">{t('enterNewPass').toLocaleUpperCase()}</label>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="email" className="form-label bold-label">{t('enterAgainNewPass').toLocaleUpperCase()}</label>
                                    <div className="position-relative">
                                        <input
                                            type={showRePassword ? 'text' : 'password'}
                                            id="re_password"
                                            className={`form-control ${formik.touched.re_password && formik.errors.re_password ? 'is-invalid' : ''}`}
                                            placeholder={t('enterAgainNewPass')}
                                            onChange={(e) => {
