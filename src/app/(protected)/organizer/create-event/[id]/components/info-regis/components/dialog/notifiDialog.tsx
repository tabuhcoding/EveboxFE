    ...
    return (
        <Dialog open={open} onClose={onClose}>
            <div className="text-white dialog-header px-6 py-4 justify-center items-center flex relative" style={{ background: '#0C4762' }}>
                <DialogTitle className="!m-0 !p-0 text-lg text-center font-bold">{transWithFallback("pendingEvent", "Sự kiện đang chờ duyệt")}</DialogTitle>
            ...
            <DialogContent className="p-6 flex flex-col text-center items-center">
                ...
                <div className="flex gap-4 mt-4 mb-4">
                    ...
                    >
                        {transWithFallback("gotIt", "Đã hiểu")}
                    </button>
                </div>
